...
Usage:
    uv run python -m nemoslides.cli.push_hf_dataset --work work_1615
    uv run python -m nemoslides.cli.push_hf_dataset --work work_1615 --push
"""
...
from nemoslides.cli.codex_pipeline import (
    MIN_DECK_BYTES,
    MIN_THINK_BYTES,
    clean_deck_markdown,
    is_substantive,
