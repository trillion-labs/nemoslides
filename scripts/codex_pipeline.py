...
Commands:
    python3 -m scripts.codex_pipeline init --seeds data/seeds.json --out work_1615
    python3 -m scripts.codex_pipeline status --work work_1615
    python3 -m scripts.codex_pipeline pack --work work_1615 --out data/raw/codex
"""
...
from pipeline.slidev_reference import (
    ALLOWED_LAYOUTS,
    ALLOWED_THEMES,
    SLIDEV_CHEATSHEET,
    TASK_INSTRUCTIONS,
...
HERO_EXAMPLE_PATH = Path("reference/gold_examples/hero_tech_talk.md")
...
def init_workspace(seeds: list[dict[str, Any]], out_dir: Path, repo_root: Path | None = None) -> dict[str, int]:
    ...
    hero_src = repo_root / HERO_EXAMPLE_PATH
